...
const linkOfTheWeek = `https://blog.evernote.com/blog/2017/03/06/thinking-small-habits-hold-key-staying-productive`;
            ...
            <table class="container" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr style="margin: 10px 0;">
                ...
                <td class="half-block__content" style="width: 50%; padding: 0 20px 0 20px; font-size: 16px; line-height: 27px; color: #969696; text-align: left;">
                  ...
                  <a href="${collection.url}" target="_blank" title="read more" style="color: #5a6677; text-decoration: underline">read more</a>
                </td>
              </tr>
            </table>
          </td>
          ...
          <table class="container" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr style="margin: 10px 0;">
              <td class="half-block__content" style="width: 50%; padding: 0 20px 0 20px; font-size: 16px; line-height: 27px; color: #969696; text-align: center;">
                Nothing was bookmarked the past week. Why not start with something hand picked? <a href="${linkOfTheWeek}" target="_blank" title="Link of the week." style="color: #5a6677; text-decoration: underline">Check it out</a>.
              </td>
            </tr>
          </table>
        </td>
...
<body style="padding: 0; margin: 0;" bgcolor="#eeeeee">
  <span style="color:transparent !important; overflow:hidden !important; display:none !important; line-height:0px !important; height:0 !important; opacity:0 !important; visibility:hidden !important; width:0 !important; mso-hide:all;">Hey ${user.name} here is your weekly reminder.</span>
          ...
          <tr>
            <td align="center" valign="top">
              ...
              <table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0" width="620" style="width: 620px;">
                ...
                <tr>
                  <td class="hero-subheader__content" style="font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 30px 0;" align="left">This is your weekly reminder containing what you have bookmarked the past week. Good reading!</td>
                </tr>
              </table>
              <!-- /// Hero subheader -->
                ...
                <tr>
                  <td align="center" valign="top">
                    <table class="container" border="0" cellpadding="0" cellspacing="0" width="620" style="width: 620px;">
                      <tr>
                        <td style="border-bottom: solid 1px #eeeeee; padding: 35px 0 18px 0; font-size: 26px; color: #5a6677;" align="left">Latest bookmarks</td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td align="center">
                    <table class="container" border="0" cellpadding="0" cellspacing="0" width="620" align="center" style="width: 620px;">
                      <tr>
                        ...
                        Copyright &copy; 2017 <a href="http://solshal.com/" target="_blank" title="Solshal - Bookmarking alternative to pocket. it's secure. it's modern." style="text-decoration: none; border-bottom: 1px solid #d5d5d5; color: #d5d5d5;">Solshal</a>. All rights reserved.
                        <br />
                        If you to stop receiving email reminder you can unsubscribe on your <a href="http://solshal.com/${user.username}/profile" target="_blank" title="Solshal - Bookmarking alternative to pocket. it's secure. it's modern." style="text-decoration: none; border-bottom: 1px solid #d5d5d5; color: #d5d5d5;">profile page</a>.
                        </td>
                      </tr>
                    </table>
                  </td>
