...
const linkOfTheWeek = `https://goo.gl/94HUZ9`;
      ...
      <tr>
        <td>
          <table class="container" border="0" cellpadding="0" cellspacing="0" width="100%" style="padding: 0 40px">
            <tr style="margin: 10px 0;">
              <td class="half-block__content" style="width: 50%; font-size: 16px; line-height: 27px; color: #969696; text-align: left;">
              "Most of us are constantly trying to find ways to keep ourselves operating at a faster, more productive, more focused pace..."
              <a href="${linkOfTheWeek}" target="_blank" title="Link of the week." style="color: #5a6677; text-decoration: underline"> Tell me more</a>.
              </td>
            </tr>
          </table>
        </td>
