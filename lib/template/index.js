...
const linkOfTheWeek = `https://www.quora.com/Whats-something-that-sucks-about-being-a-man/answer/Shanks-Wang?srid=5krs`;
...
const collectionList = (collections) => {
  ...
  if (collections.length > 0) {
    _.forEach(collections, (collection) => {
      ...
      if (_.isEmpty(collection.thumbnail)) {
        list += `
          <!-- / Half block -->
              ...
              <td>
                <table class="container" border="0" cellpadding="0" cellspacing="0" width="100%" style="padding: 0 40px">
                  <tr style="margin: 10px 0;">
                    <td class="half-block__content" style="width: 50%; font-size: 16px; line-height: 27px; color: #969696; text-align: left;">
                      <p>${collection.original.description}</p>
                      <a href="${collection.url}" target="_blank" title="read more" style="color: #5a6677; text-decoration: underline">${collection.url}</a>
                    </td>
                  </tr>
                </table>
              </td>
                ...
                <table class="container" border="0" cellpadding="0" cellspacing="0" width="100%" style="padding: 0 40px">
                  <tr style="margin: 10px 0;">
                    <td class="half-block__image" width="5%">
                      <img src="${collection.thumbnail}" width="250" height="150" alt="${collection.title}">
                    </td>
