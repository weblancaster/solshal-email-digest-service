          ...
          <table class="container" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr style="margin: 10px 0;">
              <td class="half-block__content" style="width: 50%; padding: 0 20px 0 20px; font-size: 16px; line-height: 27px; color: #969696; text-align: center;">
                Nothing was bookmarked the past week. Why not start with something hand picked? <a href="https://youtu.be/sjxNTcsquG8" target="_blank" title="Solshal - modern, secure bookmarking" style="color: #5a6677; text-decoration: underline">Check it out</a>.
              </td>
            </tr>
          </table>
        </td>
