          ...
          <table class="container" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr style="margin: 10px 0;">
              <td class="half-block__content" style="width: 50%; padding: 0 20px 0 20px; font-size: 16px; line-height: 27px; color: #969696; text-align: center;">
                ...
                <a href="http://www.solshal.com" target="_blank"
                  title="Solshal - modern, secure bookmarking" style="color: #5a6677; text-decoration: underline">Start now</a> and receive a reminder of what you have bookmarked during the week.
              </td>
            </tr>
          </table>
        </td>
          ...
          <tr>
            <td align="center" valign="top">
              ...
              <table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0" width="620" style="width: 620px;">
                <tr>
                  <td class="hero-subheader__title" style="font-size: 30px; font-weight: bold; padding: 60px 0 15px 0; color: #5a6677;" align="left">Hey ${user.name}</td>
                </tr>
