                ...
                <tr>
                  <td align="center">
                    <table class="container" border="0" cellpadding="0" cellspacing="0" width="620" align="center" style="width: 620px;">
                      <tr>
                        <td style="color: #d5d5d5; text-align: center; font-size: 15px; padding: 10px 0 60px 0; line-height: 22px;">Copyright &copy; 2016 <a href="http://solshal.com/" target="_blank" title="Solshal - Bookmarking alternative to pocket. it's secure. it's modern. it's free." style="text-decoration: none; border-bottom: 1px solid #d5d5d5; color: #d5d5d5;">Solshal</a>.
