const linkOfTheWeek = require("../config/constants").linkOfTheWeek;
const linkThumbnail = require("../config/constants").linkThumbnail;
const linkDescription = require("../config/constants").linkDescription;
